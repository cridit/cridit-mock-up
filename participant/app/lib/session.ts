...
export type PreflightAnswers = {
  ...
  hrExplainabilityImportance?: number;
  ...
  hrEfficiencyImportance?: number;
  hrCorrectionAbilityImportance?: number;
  hrDistrustTriggers?: string;
  hrNeverTrustTasks?: string;
  ...
  sourceGroundingImportance?: number;
  ...
  legalBiasFairnessImportance?: number;
  legalPrivacySecurityImportance?: number;
